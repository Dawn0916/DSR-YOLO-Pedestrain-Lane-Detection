...
class VideoHandler:
    ...
    def process_frame(self, frame):
        ...
        resized_frame = cv2.resize(frame, (640, 360))  # or smaller (e.g., 480x270)

        # Perform YOLOv8 object detection on the resized frame
        results = self.model(resized_frame, conf=0.3, iou=0.5, device=self.device)
